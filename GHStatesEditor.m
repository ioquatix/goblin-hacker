...
- (unsigned char) cursed{
   return [document byteValue:41 line:27];
}

- (void) setCursed: (unsigned char)val {
   [document setByteValue:41 line:27 to:val];
}
...
- (IBAction) show: (id)sender {	
	[window setContentView:statesEditorView];
}

@synthesize window;
@synthesize document;
@synthesize statesEditorView;
@synthesize statesTable;
@end
